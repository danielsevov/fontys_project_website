...
if($data1[0] == 0){
  ...
  echo 'Not registered yet? <a href ="register.php">Click here.</a>';
      ...
      try {
          ...
          $mail->Body    = "Dear $username, you indicated that you did not know your password anymore. In order to reset your password, you will need to submit the following code into the form at Songify: '$ccode'. Kind regards, Songify";
