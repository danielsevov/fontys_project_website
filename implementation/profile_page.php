...
echo'  <h1>Your account details</h1>
  ...
  if($account_type != 'visitor' && file_exists($filecheck) == TRUE){
  echo'<p align = "center"><img src="images/profile_pictures/'.$pfpname.'.png" width="120" height="100">';
  }
  elseif($account_type != 'visitor' && file_exists($filecheck) == FALSE){
  echo'<p align = "center"><img src="/source_images/profile_icon_blue.png" width="60" height="60">';
  }



  echo '<h2>Change your profile picture (.png format)</h2>
