...
if(isset($data1)){
  ...
  echo "<p align = 'center'><br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Error: the email address '$emailadd' was already registered.</p>";
  $succession = false;
}elseif($pass != $rpass){
  ...
  $succession = false;
      ...
      try {
          ...
          $mail->Body    = "Dear $usrname, thanks for registering at Songify! In order to complete the registration process, you will need to submit the following code into the form at Songify so we can verify your email account: '$ccode'. Kind regards, Songify";
